...
namespace DANN.Web.Controllers
{
    ...
    public static class MenuCommon
    {
        public static IAD_MenuService _menuService;

        public static IEnumerable<AD_Menu> GetListOrdered(int? parentID = null)
        {
            int i = 0;
            foreach (var item in _menuService.GetAllAsQueryable()
                .Where(x => x.ParentId == parentID)
               .OrderBy(x => x.MenuSort)
               .ToList())
            {
        ...
        public static ASPxMenu BuildMenu(ASPxMenu menu)
        {
            List<AD_Menu> menus = _menuService.GetList().ToList();
    ...
    public class ADMenuController : CommonController<AD_Menu, AD_Menu, AD_Menu>
    {
            ...
            : base(service, service1, service2)
        {
            ...
            MenuCommon._menuService = menuService;
        }
    }
