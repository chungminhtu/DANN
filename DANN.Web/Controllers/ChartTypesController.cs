...
namespace DANN.Web.Controllers
{
    public class ChartTypesController : Controller
    {
        ...
        //public override string Name { get { return "ChartTypes"; } }
    ...
    public class ChartNestedDoughnutViewDemoOptions : ChartViewTypeDemoOptions
    {
        ...
        public ChartNestedDoughnutViewDemoOptions()
        {
    ...
    public class ChartSeriesBindingDemoOptions
    {
        ...
        {    
            //todo
            //categories = binhthuan.GetCategoriesNames();
        }
    }
    ...
    public static class ChartDemoHelper
    {
        ...
        public static List<SelectListItem> GetBarViews()
        {
            return new List<SelectListItem>() {
                new SelectListItem() { Text = "Dạng cột", Value = DevExpress.XtraCharts.ViewType.Bar.ToString() },
                new SelectListItem() { Text = "Dạng đường dây", Value = DevExpress.XtraCharts.ViewType.Line.ToString() },
                new SelectListItem() { Text = "Dạng bánh", Value = DevExpress.XtraCharts.ViewType.Pie.ToString() },
                 new SelectListItem() { Text = "Dạng Radar Line", Value = DevExpress.XtraCharts.ViewType.RadarLine.ToString() },
